...
public class RefactorPersetujuanCutiIzinView extends Main {
    ...
    private static final Logger log = LoggerFactory.getLogger(RefactorPersetujuanCutiIzinView.class);
    ...
    public RefactorPersetujuanCutiIzinView(CurrentUser currentUser, CommonService commonService) {
