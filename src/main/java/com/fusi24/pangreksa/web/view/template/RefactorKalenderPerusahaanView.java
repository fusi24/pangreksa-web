...
public class RefactorKalenderPerusahaanView extends Main {
    ...
    private static final Logger log = LoggerFactory.getLogger(RefactorKalenderPerusahaanView.class);
    ...
    public RefactorKalenderPerusahaanView(CurrentUser currentUser, CommonService commonService) {
