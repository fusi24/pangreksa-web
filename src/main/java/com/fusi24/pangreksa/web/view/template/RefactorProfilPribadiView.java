...
public class RefactorProfilPribadiView extends Main {
    ...
    private static final Logger log = LoggerFactory.getLogger(RefactorProfilPribadiView.class);
    ...
    public RefactorProfilPribadiView(CurrentUser currentUser, CommonService commonService) {
