...
public class RefactorAbsensiKaryawanFormView extends Main {
    ...
    private static final Logger log = LoggerFactory.getLogger(RefactorAbsensiKaryawanFormView.class);
    ...
    public RefactorAbsensiKaryawanFormView(CurrentUser currentUser, CommonService commonService) {
