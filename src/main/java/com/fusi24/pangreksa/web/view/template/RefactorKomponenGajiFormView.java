...
public class RefactorKomponenGajiFormView extends Main {
    ...
    private static final Logger log = LoggerFactory.getLogger(RefactorKomponenGajiFormView.class);
    ...
    public RefactorKomponenGajiFormView(CurrentUser currentUser, CommonService commonService) {
