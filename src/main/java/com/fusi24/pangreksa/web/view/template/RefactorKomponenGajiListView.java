...
public class RefactorKomponenGajiListView extends Main {
    ...
    private static final Logger log = LoggerFactory.getLogger(RefactorKomponenGajiListView.class);
    ...
    public RefactorKomponenGajiListView(CurrentUser currentUser, CommonService commonService) {
