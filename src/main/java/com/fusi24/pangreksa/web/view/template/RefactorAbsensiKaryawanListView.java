...
public class RefactorAbsensiKaryawanListView extends Main {
    ...
    private static final Logger log = LoggerFactory.getLogger(RefactorAbsensiKaryawanListView.class);
    ...
    public RefactorAbsensiKaryawanListView(CurrentUser currentUser, CommonService commonService) {
