...
public class RefactorKalendarKerjaFormView extends Main {
    ...
    private static final Logger log = LoggerFactory.getLogger(RefactorKalendarKerjaFormView.class);
    ...
    public RefactorKalendarKerjaFormView(CurrentUser currentUser, CommonService commonService) {
