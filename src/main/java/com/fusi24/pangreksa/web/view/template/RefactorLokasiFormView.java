...
public class RefactorLokasiFormView extends Main {
    ...
    private static final Logger log = LoggerFactory.getLogger(RefactorLokasiFormView.class);
    ...
    public RefactorLokasiFormView(CurrentUser currentUser, CommonService commonService) {
