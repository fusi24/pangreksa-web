...
public class RefactorCabangView extends Main {
    ...
    private static final Logger log = LoggerFactory.getLogger(RefactorCabangView.class);
    ...
    public RefactorCabangView(CurrentUser currentUser, CommonService commonService) {
