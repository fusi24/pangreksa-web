...
public class PayrollView extends Main {
    ...
    private void initializeView() {
        ...
        // 4) Total Tunjangan (hr_payroll_calculations.total_allowances)
        grid.addColumn(payroll -> {
            HrPayrollCalculation calc = payroll.getCalculation();
            BigDecimal val = calc == null ? BigDecimal.ZERO : nvl(calc.getTotalAllowances());
            return FormattingUtils.formatPayrollAmount(val);
        }).setHeader("Total Tunjangan").setWidth("160px").setFlexGrow(0);
        ...
        grid.addComponentColumn(payroll -> {
            ...
            return actions;
        }).setHeader("Aksi").setWidth("160px").setFlexGrow(0);
        ...
        // Add Payroll Button
        Button addButton = new Button("Tambah Payroll", e -> openAddPayrollDialog());
    ...
    public static class RecalculateForm extends FormLayout {
        ...
        private final Button cancelButton = new Button("Batal");
        ...
        private void configureLayout() {
            ...
            Span s4 = new Span("Tambah Component");
