...
public class RefactorCatatanKehadiranKaryawanView extends Main {
    ...
    private static final Logger log = LoggerFactory.getLogger(RefactorCatatanKehadiranKaryawanView.class);
    ...
    public RefactorCatatanKehadiranKaryawanView(CurrentUser currentUser, CommonService commonService) {
