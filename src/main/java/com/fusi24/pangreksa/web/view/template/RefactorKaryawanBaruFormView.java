...
public class RefactorKaryawanBaruFormView extends Main {
    ...
    private static final Logger log = LoggerFactory.getLogger(RefactorKaryawanBaruFormView.class);
    ...
    public RefactorKaryawanBaruFormView(CurrentUser currentUser, CommonService commonService) {
