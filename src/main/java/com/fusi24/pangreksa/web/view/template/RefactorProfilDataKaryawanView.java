...
@Menu(order = 14, icon = "vaadin:clipboard-check", title = "Profil Data Karyawan")
@RolesAllowed("PROFIL_KAR")
//@PermitAll // When security is enabled, allow all authenticated users
public class RefactorProfilDataKaryawanView extends Main {
    private static final long serialVersionUID = 11L;
    private static final Logger log = LoggerFactory.getLogger(RefactorProfilDataKaryawanView.class);
    ...
    public RefactorProfilDataKaryawanView(CurrentUser currentUser, CommonService commonService) {
