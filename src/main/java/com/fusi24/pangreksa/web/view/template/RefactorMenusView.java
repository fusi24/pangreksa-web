...
public class RefactorMenusView extends Main {
    ...
    private static final Logger log = LoggerFactory.getLogger(RefactorMenusView.class);
    ...
    public RefactorMenusView(CurrentUser currentUser, CommonService commonService) {
