...
public class RefactorCutiIzinFormView extends Main {
    ...
    private static final Logger log = LoggerFactory.getLogger(RefactorCutiIzinFormView.class);
    ...
    public RefactorCutiIzinFormView(CurrentUser currentUser, CommonService commonService) {
