...
public class RefactorSlipGajiKaryawanView extends Main {
    ...
    private static final Logger log = LoggerFactory.getLogger(RefactorSlipGajiKaryawanView.class);
    ...
    public RefactorSlipGajiKaryawanView(CurrentUser currentUser, CommonService commonService) {
