...
public class RefactorKalendarKerjaView extends Main {
    ...
    private static final Logger log = LoggerFactory.getLogger(RefactorKalendarKerjaView.class);
    ...
    public RefactorKalendarKerjaView(CurrentUser currentUser, CommonService commonService) {
