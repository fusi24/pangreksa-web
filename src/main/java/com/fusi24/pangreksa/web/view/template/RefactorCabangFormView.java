...
public class RefactorCabangFormView extends Main {
    ...
    private static final Logger log = LoggerFactory.getLogger(RefactorCabangFormView.class);
    ...
    public RefactorCabangFormView(CurrentUser currentUser, CommonService commonService) {
