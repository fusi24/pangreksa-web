...
public class ConfirmationDialogUtil {
     ...
     * @param text The main message explaining the action (e.g., "Apakah Anda yakin ingin menghapus this item?").
     * @param confirmText The label for the confirmation button (e.g., "Hapus").
